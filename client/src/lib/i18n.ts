...
const en = {
  ...
  breeding: {
    ...
    promoted: "Promoted",
    promotedAnimalDeleted: "Promoted animal deleted",
    promotedAnimalPurged: "Promoted animal purged",
    viewPromotedAnimal: "View promoted animal profile",
    promoting: "Promoting…",
  ...
  pregnancy: {
    ...
    subtitle: "Confirmed pregnancies and expected delivery follow-up",
    record: "Record Pregnancy",
    edit: "Edit Pregnancy",
    animal: "Female animal",
    selectFemale: "Select a female animal",
    sire: "Sire (optional)",
    ...
    progress: "Progress",
    checkupDate: "Checkup date (optional)",
    notifyBeforeDue: "Alert days before delivery",
    notifyBeforeCheckup: "Alert days before checkup",
    notes: "Notes",
    status: "Status",
    active: "Active",
    due: "Due soon",
    ...
    allStatuses: "All statuses",
    save: "Save",
    recorded: "Pregnancy recorded",
    updated: "Pregnancy updated",
    deleted: "Pregnancy record deleted",
    deleteConfirm: "Delete this pregnancy record?",
    noActive: "No active pregnancy",
    reproductiveHistory: "Reproductive history",
    totalPregnancies: "Total pregnancies",
    lastDelivery: "Last delivery",
    gestationDays: "Gestation period (days)",
    ...
    dashDueSoon: "pregnancies due soon",
    dashOverdue: "pregnancies overdue",
  },
  ...
  pnl: {
    ...
    allocatedGeneralExpenses: "Allocated General Expenses",
    saleRevenue: "Sale Revenue",
    projectedCostToTarget: "Projected cost to target",
    viewCostDetails: "View cost details",
    costDetailsTitle: "Cost details · {{animal}}",
    costDetailsDescription: "Every cost currently assigned to this animal.",
    expenseAllocations: "Expense allocations",
    expenseBreakdown: "Expense breakdown",
    directAllocation: "Direct",
    categoryAllocation: "Category share",
    herdAllocation: "Animal-wide share",
    generalAllocation: "Farm share",
    noAllocatedExpenses: "No expenses are assigned to this animal yet.",
    otherExpenses: "Other expenses",
    allocationHelp: "Direct expenses are charged in full. Category and animal-wide bills are split between animals alive when the expense was recorded.",

    herdExp: "Herd Exp.",
    animalOperatingCost: "Animal Operating Cost",
    animalOperatingCostSub: "Feed + all allocated expenses",
    ...
    currentAccountValueSub: "Net Revenue + Capital − Operating Costs",
    netRevenue: "Net Revenue (after reinvestment)",
    netRevenueSub: "Realised revenue minus what's been reinvested into new stock",
    fundingRevenue: "Revenue",
    fundingInvestment: "Investment",
    fundingSource: "Funding source",
    fundingSourceRevenueLabel: "Farm revenue",
    fundingSourceInvestmentLabel: "New investment",
    fundingSourceRequired: "Choose how this purchase was funded",
  ...
  sales: {
    ...
    pricePerKgHelp: "Enter a rate to calculate prices from weights, or leave blank for manual prices.",
    extraCharge: "Extra charge (optional)",
    extraChargeHelp: "Added once to the sale, split by animal value and included in each animal's price.",
    includingCharge: "Including charge",
    subtotal: "Animals subtotal",
    totalWeight: "Total weight",
    invalidBulkPricing: "Check pricing: use positive weights for kg pricing, non-negative amounts with up to 2 decimals, and payments no higher than each animal's total.",
  ...
  animalProfile: {
    ...
    viewBirthRecord: "View linked birth record",
  ...
  owners: {
    ...
    scopedNote: "Showing only {{owner}}'s animals. Farm-wide costs (overhead, feed) are excluded.",
    addOwner: "Add Owner",
...
const ar = {
  ...
  breeding: {
    ...
    birthRequiredFields: "النوع وفئة الحمل والجنس ونوع الولادة حقول مطلوبة",
    ...
    promotedAnimalDeleted: "تم حذف الحيوان المُرقّى",
    promotedAnimalPurged: "تم حذف الحيوان المُرقّى نهائيًا",
    viewPromotedAnimal: "عرض ملف الحيوان المُرقّى",
  ...
  pregnancy: {
    title: "متابعة الحمل",
    subtitle: "حالات الحمل المؤكدة ومتابعة موعد الولادة المتوقع",
    record: "تسجيل حمل",
    edit: "تعديل الحمل",
    animal: "الحيوان (أنثى)",
    selectFemale: "اختر حيوانًا أنثى",
    sire: "الأب (اختياري)",
    confirmationDate: "تاريخ تأكيد الحمل",
    dueDate: "موعد الولادة المتوقع",
    daysPregnant: "أيام الحمل",
    daysRemaining: "الأيام المتبقية",
    progress: "نسبة التقدم",
    checkupDate: "تاريخ الفحص (اختياري)",
    notifyBeforeDue: "التنبيه قبل الولادة بأيام",
    notifyBeforeCheckup: "التنبيه قبل الفحص بأيام",
    notes: "ملاحظات",
    status: "الحالة",
    active: "نشط",
    due: "قريب الموعد",
    ...
    aborted: "إجهاض",
    lost: "فقدان",
    markDelivered: "تسجيل الولادة",
    noRecords: "لا توجد سجلات حمل",
    allStatuses: "كل الحالات",
    save: "حفظ",
    recorded: "تم تسجيل الحمل",
    updated: "تم تحديث الحمل",
    deleted: "تم حذف سجل الحمل",
    deleteConfirm: "حذف سجل الحمل هذا؟",
    noActive: "لا يوجد حمل نشط",
    reproductiveHistory: "السجل التناسلي",
    totalPregnancies: "إجمالي حالات الحمل",
    lastDelivery: "آخر ولادة",
    gestationDays: "مدة الحمل (أيام)",
    summaryActive: "نشط",
    summaryDueSoon: "قريب الموعد",
    summaryOverdue: "متأخر",
    summaryDelivered: "تمت الولادة",
    dueIn: "متبقٍ {{days}} يوم",
    overdueBy: "متأخر {{days}} يوم",
    dashDueSoon: "حالات حمل قريبة الموعد",
    dashOverdue: "حالات حمل متأخرة",
  },
  ...
  vaccine: {
    ...
    boosterDueDate: "تاريخ الجرعة المنشطة",
    boosterDue: "موعد الجرعة المنشطة",
  ...
  pnl: {
    ...
    allocatedGeneralExpenses: "المصروفات العامة المخصصة",
    saleRevenue: "إيراد البيع",
    projectedCostToTarget: "التكلفة المتوقعة حتى الوزن الهدف",
    viewCostDetails: "عرض تفاصيل التكلفة",
    costDetailsTitle: "تفاصيل التكلفة · {{animal}}",
    costDetailsDescription: "كل تكلفة مخصصة لهذا الحيوان حاليًا.",
    expenseAllocations: "المصروفات المخصصة",
    expenseBreakdown: "تفصيل المصروفات",
    directAllocation: "مباشر",
    categoryAllocation: "حصة الفئة",
    herdAllocation: "حصة القطيع",
    generalAllocation: "حصة المزرعة",
    noAllocatedExpenses: "لا توجد مصروفات مخصصة لهذا الحيوان بعد.",
    otherExpenses: "مصروفات أخرى",
    allocationHelp: "تُحمّل المصروفات المباشرة بالكامل، بينما تُقسّم فواتير الفئة والقطيع بين الحيوانات الموجودة عند تسجيل المصروف.",

    herdExp: "مصروف القطيع",
    animalOperatingCost: "التكلفة التشغيلية للحيوان",
    animalOperatingCostSub: "العلف + كل المصروفات المخصصة",
    ...
    currentAccountValueSub: "صافي الإيراد + رأس المال − التكاليف التشغيلية",
    netRevenue: "صافي الإيراد (بعد إعادة الاستثمار)",
    netRevenueSub: "الإيراد المحقق ناقص ما تم إعادة استثماره في مخزون جديد",
    fundingRevenue: "إيراد",
    fundingInvestment: "استثمار",
    fundingSource: "مصدر التمويل",
    fundingSourceRevenueLabel: "إيراد المزرعة",
    fundingSourceInvestmentLabel: "استثمار جديد",
    fundingSourceRequired: "اختر كيف تم تمويل هذا الشراء",
  ...
  sales: {
    ...
    pricePerKgHelp: "أدخل سعر الكيلو لحساب الأسعار من الأوزان، أو اتركه فارغاً لإدخال الأسعار يدوياً.",
    extraCharge: "رسوم إضافية (اختياري)",
    extraChargeHelp: "تضاف مرة واحدة للبيع، وتوزع حسب قيمة الحيوانات وتدرج في سعر كل حيوان.",
    includingCharge: "شامل الرسوم",
    subtotal: "إجمالي أسعار الحيوانات",
    totalWeight: "إجمالي الوزن",
    invalidBulkPricing: "راجع الأسعار: أوزان موجبة للتسعير بالكيلو، ومبالغ غير سالبة بخانتين عشريتين كحد أقصى، والمدفوع لا يتجاوز إجمالي كل حيوان.",
  ...
  animalProfile: {
    ...
    birthRecord: "سجل الولادة",
    viewBirthRecord: "عرض سجل الولادة المرتبط",
  ...
  owners: {
    ...
    scopedNote: "عرض حيوانات {{owner}} فقط. التكاليف العامة للمزرعة (المصاريف العامة، العلف) مستبعدة.",
    addOwner: "إضافة مالك",
...
const __newEn = {
  ...
  "expenses": {
    ...
    "createdN": "Created {{count}} expense rows",
    "date": "Date",
    "editSingleTarget": "Editing affects one expense row — select exactly one category",
    ...
    "splitEqual": "Equal per category",
    "splitHint": "One expense row is created per category.",
    "splitMode": "Split across categories",
...
const __newAr = {
  ...
  "expenses": {
    ...
    "createdN": "تم إنشاء {{count}} قيود مصروفات",
    "date": "التاريخ",
    "editSingleTarget": "التعديل يؤثر على قيد مصروف واحد — اختر فئة واحدة فقط",
    ...
    "splitByHeadcount": "حسب عدد الرؤوس",
    "splitEqual": "بالتساوي لكل فئة",
    "splitHint": "يُنشأ قيد مصروف واحد لكل فئة.",
    "splitMode": "توزيع المبلغ بين الفئات",
